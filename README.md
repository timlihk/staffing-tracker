...
- **Control Tower UX** — All three table views now support column sorting by project name; B&C Attorney filter upgraded to searchable Autocomplete
...
**Release v5.1.0 — Control Tower & Milestone Detection:**
...
### Completed - Performance & UX Polish (v5.2.0)
...
- Control Tower sortable tables and searchable attorney filter
